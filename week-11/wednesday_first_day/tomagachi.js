...
function DigitalPal(hungry, sleepy, bored, age) {
	...
	// The fourth method is "increaseAge()" - This method runs within the sleepy() method when the DigitalPal goes to sleep
	 // and increases the DigitalPal's age by one while also printing "Happy Birthday to me! I am "+age+" old!"
...
const Fred = new DigitalPal(false, false, true, 0);
