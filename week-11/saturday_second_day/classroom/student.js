// In this activity we are going to make two constructors in two different files in which one constructor calls 
// upon the other within it.
...
console.log("Students hooked in");

function Student (studentName, subject, gpa) {
